...
side_hustles = [
    ...
    "Social Media Management - Manage accounts for brands and influencer!",
...
money_quotes = [
    ...
    "Formal education will make you a living; self-education will make you a fortune. – Jim John",
    ...
    "Rich people have small TVs and big libraries, and poor people have small libraries and big TVs. – Zig Ziegler",
